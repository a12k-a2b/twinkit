...
export const SIMPLE_PRESETS: ProfilePreset[] = [
  {
    ...
    modules: ["core", "claude", "codex", "chrome", "permissions", "ssh", "transfer"],
  },
  {
    id: "claude-sidekicks",
    ...
    modules: ["core", "claude", "codex", "grok", "muse", "chrome", "permissions", "ssh", "transfer"],
  },
  {
    id: "daylight-android",
    ...
    modules: ["core", "claude", "codex", "grok", "muse", "android", "daylight", "chrome", "permissions", "ssh", "transfer"],
  },
];
